...
void printWiFiInfo() {
// IP needs to be converted to hex and then reversed and then byte wise
// transformed to dezimal to be readable. e.g 1387440320 to hex 0x52B2A8C0 -> 52
// B2 A8 C0 reverse to C0 A8 B2 52 to dec 192.168.178.82 255 255 255 0
// 192.168.178.236
#if (WIFI == 1)
  logInfoln(("[WiFi] IP: " + String(ip) + "; Subnet: " + String(subnet) +
